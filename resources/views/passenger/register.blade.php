...
<head>
    ...
    <title>乘客註冊 - {{ config('app.name') }}</title>
    ...
    <style>
        ...
        .form-card { box-shadow: 0 1rem 3rem rgba(0,0,0,.175); border-radius: 1rem; }
    </style>
</head>
        ...
        <div class="card form-card">
            <div class="card-body p-4 p-md-5">
                <div class="text-center mb-4">
                    ...
                    <h1 class="h4 mt-2 mb-1">乘客註冊</h1>
                    <p class="text-muted small">請輸入手機號碼與密碼</p>
                </div>
                ...
                <form method="POST" action="{{ route('passenger.register') }}">
                    @csrf
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input id="phone" name="phone" type="tel" value="{{ old('phone') }}" required autofocus
                                class="form-control" placeholder="0912345678" maxlength="10" pattern="09[0-9]{8}"
                                title="請輸入 09 開頭 10 碼手機號碼">
                        </div>
                        <div class="form-text">請輸入 09 開頭 10 碼手機號碼</div>
                    </div>
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input id="password" name="password" type="password" required
                                class="form-control" placeholder="至少 6 個字元" minlength="6">
                        </div>
                    </div>
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input id="password_confirmation" name="password_confirmation" type="password" required
                                class="form-control" placeholder="再輸入一次密碼" minlength="6">
                        </div>
                    </div>
                ...
                <p class="text-center text-muted small mb-0">
                    已有帳號？<a href="{{ route('passenger.login') }}">前往登入</a>
                </p>
            </div>
        </div>
