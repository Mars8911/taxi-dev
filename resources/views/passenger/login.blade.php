...
<head>
    ...
    <title>乘客登入 - {{ config('app.name') }}</title>
    ...
    <div class="w-100" style="max-width: 400px;">
        <div class="card login-card">
            <div class="card-body p-4 p-md-5">
                ...
                <form method="POST" action="{{ route('passenger.login') }}">
                    @csrf
                    <div class="mb-3">
                ...
                <p class="text-center text-muted small mb-0">
                    還沒有帳號？<a href="{{ route('passenger.register') }}">立即註冊</a>
                </p>
            </div>
        </div>
